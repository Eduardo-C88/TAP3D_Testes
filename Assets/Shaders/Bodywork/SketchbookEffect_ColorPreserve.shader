Shader "Unlit/SketchbookEffect_ColorPreserve"
{
    Properties
    {
        ...
        _PaperColor ("Paper Color", Color) = (0.9, 0.85, 0.8, 1) // Warm off-white default
        _PaperContrast ("Paper Contrast", Range(0, 2)) = 1.0
        
        [Header(Noise Settings)]
        _NoiseScale ("Noise Scale", Range(0, 10)) = 5.0
        _PencilRoughness ("Pencil Roughness", Range(0, 1)) = 0.3
        _ColorThreshold ("Color Protection Threshold", Range(0, 1)) = 0.2
